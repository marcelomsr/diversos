...
namespace ConsoleRecorderCore
{
    class RecorderManager
    {
        ...
        {
            string[] parametros_retorno = enviar_comando(String.Format("{0:000}@{1}$", (int)RecorderInteraction.Command.COMANDO_OBTER_GRAVACAO, sqc_gravacao));
        ...
        public string gravar(int chamadaID, int dispositivo, int quota = 1)
        {
            ...
            string[] parametros_retorno = enviar_comando(String.Format("{0:000}@{1}&{2}&{3}&{4}&{5}&{6}&{7}$",
                (int)RecorderInteraction.Command.COMANDO_INICIAR_GRAVACAO_CHAMADA, _requisicao_ID, chamadaID, dispositivo, cdg_agente, sqc_ligacao_atendida, dados_extra, quota));
        ...
        public string parar_gravar(int gravacaoID)
        {
            ...
            string[] parametros_retorno = enviar_comando(String.Format("{0:000}@{1}&{2}&{3}&{4}$",
                RecorderInteraction.Command.COMANDO_PARAR_GRAVACAO_CHAMADA, _requisicao_ID, gravacaoID, motivo, dta_permanencia));
        ...
        {
            string[] parametros_retorno = enviar_comando(String.Format("{0:000}@$", (int)RecorderInteraction.Command.COMANDO_OBTER_VERSAO));
